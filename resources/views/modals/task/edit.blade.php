            ...
            <form  wire:submit="update">
                ...
                <div class="mt-4 text-gray-600">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" wire:model="due" id="due" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200 bg-gray-300" disabled>
                        @error('due')
                            <span class="text-red-500 text-xs">{{ $message }}</span>
                        @enderror
                    </div>
